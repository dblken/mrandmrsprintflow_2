...
revision_test_assert(strpos($staffCustomizations, '...this.parseSpecsObject(item.customization_data || {})') !== false && strpos($staffCustomizations, '...this.parseSpecsObject(item.specifications_raw || {})') !== false, 'staff exact-field permissions originate from persisted order-item keys');
