...
revision_notification_assert(strpos($workflow, "'replacement_design'") !== false && strpos($workflow, 'type=order_item&id=') !== false, 'replacement preview uses the secure order-item endpoint');
