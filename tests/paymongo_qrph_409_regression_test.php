...
qrph_409_check(str_contains($customer, "if (!['generating', 'awaiting_payment'].includes(status))") && str_contains($customer, 'pagehide'), '18. terminal/no-payment states cannot create an infinite polling loop');
