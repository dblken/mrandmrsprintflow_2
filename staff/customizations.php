...
<head>
    ...
    <style>
        ...
        .filter-select:focus { border-color: var(--staff-primary); ring: 2px; ring-color: var(--staff-primary); box-shadow: 0 0 0 3px rgba(var(--staff-accent-rgb), 0.12); }
        ...
        .pf-customizations-table-card tbody tr:hover {
            background: linear-gradient(90deg, rgba(var(--staff-accent-rgb), 0.06) 0%, rgba(var(--staff-accent-rgb), 0.14) 100%) !important;
        }
        ...
        @media (max-width: 768px) {
            ...
            /* Order list layout uses @container customization-list tiers below. */
        ...
        /* Compact horizontal table while the list container still fits a row layout. */
        @container customization-list (min-width: 681px) and (max-width: 1100px) {
            .customizations-table-scroll {
                margin: 0 !important;
                padding: 0 !important;
                overflow-x: auto !important;
            ...
            .customizations-data-table .customization-info-cell .table-text-sub {
                white-space: normal;
                overflow-wrap: anywhere;
            }
        }
        ...
        /* The sidebar changes the list's usable width independently of the
           viewport. Stack to labeled cards only when the list container is
           genuinely too narrow for a table row. */
        @container customization-list (max-width: 680px) {
            .customizations-table-scroll {
                margin: 0 !important;
                padding: 0 !important;
    ...
    (function registerStaffCustomizationManager() {
        ...
        function createJoManager(defaultStatus) {
            ...
            async goToOrdersPage(page) {
                ...
                this.currentPage = Math.min(target, this.totalPages);
            },
            ...
            async loadOrders(options = {}) {
                ...
                const loadToken = ++this.ordersLoadToken;
                let timedOut = false;
                ...
                try {
                    ...
                    if (!silent && loadToken === this.ordersLoadToken) {
