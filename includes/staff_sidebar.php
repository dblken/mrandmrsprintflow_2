...
<aside class="sidebar staff-sidebar" id="adminSidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section">
            ...
            <a href="profile" class="nav-item menu-link active">
        ...
        <div class="nav-section">
            ...
            <a href="<?php echo $base_path; ?>/staff/dashboard.php" class="nav-item menu-link <?php echo $current_page === 'dashboard.php' ? 'active' : ''; ?>">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <?php if ($is_pos_staff): ?>
            <a href="<?php echo $base_path; ?>/staff/pos.php" class="nav-item menu-link <?php echo $current_page === 'pos.php' ? 'active' : ''; ?>">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo $base_path; ?>/staff/order_lookup.php" class="nav-item menu-link <?php echo $current_page === 'order_lookup.php' ? 'active' : ''; ?>">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo $base_path; ?>/staff/payment_verification.php" class="nav-item menu-link <?php echo $current_page === 'payment_verification.php' ? 'active' : ''; ?>">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            */ ?>
            ...
            <a href="<?php echo $base_path; ?>/staff/reports.php" class="nav-item menu-link <?php echo $current_page === 'reports.php' ? 'active' : ''; ?>">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <?php if ($is_online_staff): ?>
            <a href="<?php echo $base_path; ?>/staff/reviews.php" class="nav-item menu-link <?php echo $current_page === 'reviews.php' ? 'active' : ''; ?>">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="nav-section">
            ...
            <a href="<?php echo $base_path; ?>/staff/notifications.php" class="nav-item menu-link <?php echo $current_page === 'notifications.php' ? 'active' : ''; ?>">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
