...
.sales-txn-wrap { overflow-x:auto; -webkit-overflow-scrolling:touch; max-width:100%; }
.sales-txn-table { width:max-content; min-width:100%; table-layout:auto; }
.sales-txn-table th,
.sales-txn-table td { white-space:nowrap; padding:10px 14px; }
.sales-txn-table th:last-child,
.sales-txn-table td:last-child { text-align:right; }
.sales-txn-table .sales-breakdown-pill { white-space:nowrap; flex-shrink:0; }
